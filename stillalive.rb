...
OptionParser.new do |opts|
	opts.banner = "Usage: ./letscrate.rb [options]"

	opts.on("-c", "--noclear", "Don't clear the screen before starting") do
		$clear = false
	end

	opts.on("--notiming", "Print everything at once.") do
		$beatsize = 0
	end
end.parse!
